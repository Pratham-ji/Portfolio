...
export const UserProfile: React.FC = () => {
  ...
  return (
    <div className="mt-auto p-4 border-t border-[var(--theme-border)] flex items-center justify-between bg-black/10">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-[var(--theme-accent)] flex items-center justify-center text-white">
          <UserIcon size={20} />
        </div>
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-[var(--theme-text)]">Pratham</span>
